    ...
    def extract(self,text):
      ...
      #  matcher.add("Where", add_right, Where_pattern1,Where_pattern2,Where_pattern3)
       # matcher.add("How", add_right, How_pattern1,How_pattern2,How_pattern3,How_pattern4,How_pattern5,
        ...
        matcher.add("Who",[Who_pattern1,Who_pattern2,Who_pattern3,Who_pattern4,Who_pattern5,
                    Who_pattern6,Who_pattern7,Who_pattern8,Who_pattern9],on_match=add_label)
        matcher.add("What",[What_pattern1,What_pattern2],on_match=add_right)
       # matcher.add("Why", add_label,Why_pattern1)
        matcher.add("Mod",[Mod_pattern1,Mod_pattern2],on_match=add_right_left)
        
        matcher.add("Task",[Task_pattern1,Task_pattern2,Task_pattern3,Task_pattern4,Task_pattern5],on_match=add_label_type)
